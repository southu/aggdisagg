...
### Fixed
- `benchmarks/bench_disagg.py`: the try/except for HAS_TD was missing the `import tempdisagg` (HAS_TD was always True). Added the import line inside the try exactly as specified.
